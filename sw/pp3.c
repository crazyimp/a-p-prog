...
int setCPUtype(char *cpu) {
    ...
    while ((read = getlinex(&line, &len, sf)) != -1) {
        ...
        if (line[0] != '#') { // ignore lines starting with a # (comments)
            ...
            if (strcmp(read_cpu_type, cpu) == 0) {
                ...
                // set correct chip family
                if (strcmp("CF_P16F_A", read_algo_type) == 0)
                    chip_family = CF_P16F_A;
                else if (strcmp("CF_P16F_B", read_algo_type) == 0)
                    chip_family = CF_P16F_B;
                else if (strcmp("CF_P16F_C", read_algo_type) == 0)
                    chip_family = CF_P16F_C;
                else if (strcmp("CF_P16F_D", read_algo_type) == 0)
                    chip_family = CF_P16F_D;
                else if (strcmp("CF_P18F_A", read_algo_type) == 0)
                    chip_family = CF_P18F_A;
                else if (strcmp("CF_P18F_B", read_algo_type) == 0)
                    chip_family = CF_P18F_B;
                else if (strcmp("CF_P18F_C", read_algo_type) == 0)
                    chip_family = CF_P18F_C;
                else if (strcmp("CF_P18F_D", read_algo_type) == 0)
                    chip_family = CF_P18F_D;
                else if (strcmp("CF_P18F_E", read_algo_type) == 0)
                    chip_family = CF_P18F_E;
                else if (strcmp("CF_P18F_F", read_algo_type) == 0)
                    chip_family = CF_P18F_F;
                else if (strcmp("CF_P18F_G", read_algo_type) == 0)
                    chip_family = CF_P18F_G;
                else if (strcmp("CF_P18F_Q", read_algo_type) == 0)
